...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://obscure-mountain-23736.herokuapp.com',
...
var fileEvents = __webpack_require__(15);
...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).then(ui.signUpSuccess).then(console.log('Data is…')).then(console.log(data)).catch(ui.signUpFailure);
};
...
var getFiles = function getFiles() {
  api.getFiles().then(ui.getFilesSuccess).catch(ui.failure);
};
...
var onClearFiles = function onClearFiles(event) {
  event.preventDefault();
  ui.clearFiles();
};
...
var onNewFile = function onNewFile(event) {
  event.preventDefault();
  console.log('Modal loaded.');
  var data = new FormData(event.target);
  api.newFile(data).then(console.log('API happened.')).then(console.log(data)).then(ui.newFileSuccess(data)).then(getFiles).catch(ui.failure);
};

// Retrieve file row data on launch of Update File modal…
var saveFile = function saveFile(event) {
  store.file = {
...
var onUpdateFile = function onUpdateFile(event) {
  ...
  api.updateFile(data, store.file.file_id).then(ui.updateFileSuccess).then(getFiles).catch(ui.failure);
};

var onDeleteFile = function onDeleteFile(event) {
  event.preventDefault();
  api.deleteFile(store.file.file_id).then(ui.deleteFileSuccess).then(function () {
    return onGetFiles(event);
  }).catch(ui.failure);
};

var addFileHandlers = function addFileHandlers() {
  $('.file-return-content').on('click', saveFile).on('mouseover', '.info-td', function (event) {
  ...
  $('#nav-show-hide-files').click(function (event) {
...
var newFile = function newFile(data) {
...
var updateFile = function updateFile(data, fileId) {
  return $.ajax({
...
var showFilesTemplate = __webpack_require__(18);

var getFilesSuccess = function getFilesSuccess(data) {
  var showFilesHtml = showFilesTemplate({ files: data.files });
  $('.info-section').show();
...
var newFileSuccess = function newFileSuccess(data) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  "
    ...
    + "\"\n  data-user=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.user : stack1), depth0))
    + "\"\n  data-file-name=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.file_name : stack1), depth0))
    + "\"\n    data-date=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\"\n    data-tags=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.tags : stack1), depth0))
    + "\"\n    data-toggle=\"modal\" data-target=\"#modifyFileModal\">\n    <td class=\"user-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.user : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"file-name-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.file_name : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"date-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.date : stack1),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams),"inverse":container.program(10, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"tags-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.tags : stack1),{"name":"if","hash":{},"fn":container.program(12, data, 0, blockParams),"inverse":container.program(10, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"info-button-td\"><button type=\"button\" class=\"modify-file-button\" id=\"modify-file-button\">Modify</button></td>\n  </tr>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.user : stack1), depth0))
    + "\n";
  ...
  return "      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.file_name : stack1), depth0))
    + "\n";
  ...
  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.tags : stack1), depth0))
    + "\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<br>I'm a partial that is included every <big><i>files</i></big> iteration\n";
},"useData":true});
